#!/bin/bash
g++ -g -m64 -static -I. coroutine_example.cpp  ../libcontext.cpp -o test-linux-gcc-x86-64 -I..
g++ -g -m32 -static -I. coroutine_example.cpp  ../libcontext.cpp -o test-linux-gcc-i386  -I..
